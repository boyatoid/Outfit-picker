...
4. Replace the premade pom.xml with the provided pom.xml (it contains the project dependancies)
5. Docker is required for the project to function, it serves as the SQL database backend
